  ...
  return (
    ...
    <img src={play_icon} alt="" className='play-icon'/>
     ...
     <div className="about-right">
        ...
        and experiances needed to excel in the dynamic field of education.</p>
        <p>With focus on innovation, hands-on learning, and personalized mentorship, our program prepare
